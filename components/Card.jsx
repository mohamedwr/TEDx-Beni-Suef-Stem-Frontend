...
const Card = () => {
	...
	return (
		<div
			className='md:flex aspect-h-9 aspect-w-16 bg-gray-100 rounded-xl overflow-hidden relative select-none'
		...
		>
			<motion.img
				...
				className='absolute rounded-xl object-cover border-l-16 border-red-500'
				src='/cover.jpg'
			/>
			<div className='p-6 text-left space-y-4'>
				<figcaption className='font-medium text-white'>
					...
					<p className='text-sm lg:text-lg text-gray-200'>At 20/12/2020</p>
				</figcaption>
			</div>
			<motion.div
