...
export default function Home() {
	...
	return (
		<>
			...
			<Slider
				images={[
					"https://res.cloudinary.com/dxaqlmgag/image/upload/v1620389306/Slider/1_mibk8p.webp",
					"https://res.cloudinary.com/dxaqlmgag/image/upload/v1620389306/Slider/2_ddth74.webp",
					"https://res.cloudinary.com/dxaqlmgag/image/upload/v1620389306/Slider/3_a9pw0i.webp",
					"https://res.cloudinary.com/dxaqlmgag/image/upload/v1620389305/Slider/4_kwt6rs.webp",
				]}
			/>
					...
					<Section title="About TEDx">
						<div className="flex flex-col lg:flex-row">
							<p className="h-full pl-4 text-xl leading-relaxed text-black duration-300 ease-in-out border-l-8 border-red-500 rounded font-cairo lg:w-3/4 dark:text-white">
								<Word>TEDx</Word> is a grassroots initiative,
								created in the spirit of TED’s overall mission
								to research and discover{" "}
								<Word>“Ideas Worth Spreading”</Word>. TEDx
								brings the spirit of TED to local communities
								around the globe through TEDx events. These
								events are organized by passionate individuals
								who seek to uncover new ideas and to share the
								latest research in their local areas that spark
								conversations in their communities. TEDx events
								include live speakers and recorded TED Talks,
								and are organized independently under a free
								license granted by TED. These events are not
								controlled by TED, but event organizers agree to
								abide by our format, and are offered guidelines
								for curation, speaker coaching, event organizing
								and more. They learn from us and from each
								other. More than 3000 events are now held
								annually.{" "}
					...
					<Section title="About Us">
						<div className="flex flex-col lg:flex-row">
							<p className="h-full pl-4 text-xl leading-relaxed text-black duration-300 ease-in-out border-l-8 border-red-500 rounded font-cairo lg:w-3/4 dark:text-white">
								...
								is to spread TED&apos;s valuable aims in
								BeniSuef, exposing insights, beliefs, and
								inspirations. They can rise with us. It makes
								the subtle ideas soar in the sky of our society
								because we have the faith in every thought which
								was rejected before. And we spot the light on;
								the intrinsic ideas deserve the opportunity to
								raise in our community, turning from being
								rejected to respected because they are “IDEAS
								WORTH SPREADING“.
							</p>
